...
const schema = z.object({
   ...
   cpf: z.string().min(1).max(11),
    ...
    /* Historical Data */
    gestacoesAnteriores: z.string().min(1),
    partosNormaisAnteriores: z.string().min(1),
    partosCesarianasAnteriores: z.string().min(1),
    abortosAnteriores: z.string().min(1),
    dataUltimaGestacao: z.string().optional(),
    dataUltimaMenstruacao: z.string().optional(),
    diasMenstruada: z.string().min(1).optional(),
    intervaloEntreCiclosMenstruais: z.string().optional(),
    volumeMenstrual: z.string().optional(),
    colicas: z.string().min(1),
    ...
    porqueInserirDIU: z.string().min(1),
